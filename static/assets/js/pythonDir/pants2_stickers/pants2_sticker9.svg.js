var item = `<svg class="bottomOverlay" width="86" height="380" viewBox="202.715 584.407 86.5933 380.048" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs id="svgEditorDefs">
    ...
    <pattern id="pattern-0" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse" viewBox="0 0 100 100">
      ...
      <g transform="matrix(0.324356, 0, 0, 0.498358, 0.505488, -1.036383)">
    ...
    <pattern id="pattern-1" viewBox="0 0 100 100" patternUnits="userSpaceOnUse" preserveAspectRatio="none" width="100" height="100">
      <g id="g4947" transform="matrix(0.566424, 0, 0, 0.676714, -12.616541, -14.343151)">
        <path id="path4951" d="m2.5958 177.14c40.025 9.7687 96.547 11.765 139.52 0.67424 34.733-6.577 62.288-8.1343 87.307-6.5362l0.29-168.41c-40.49-2.7972-42.06-0.1479-89.55 6.4917-49.986 10.445-95.287 5.2723-140.17-1.2979z" style="fill:url(#linearGradient4963)"/>
      </g>
      <g id="g4973" transform="matrix(0.566424, 0, 0, 0.676714, -12.616541, -14.343151)">
        <path id="path4979" style="fill:url(#linearGradient4983)" d="m72.775 99.745-33.389-18.882-34.484 16.801 7.64-37.59-26.634-27.603 38.111-4.351 18.022-33.86 15.914 34.901 37.773 6.676-28.276 25.921z" transform="matrix(.99969 -.024698 .024698 .99969 71.214 47.164)"/>
      </g>
    </pattern>
    <pattern id="pattern-0-0" patternTransform="matrix(5.902863, 0, 0, 3.13168, 232.774506, 849.913574)" xlink:href="#pattern-0"/>
    <symbol id="symbol-0" viewBox="0 0 100 100"/>
    <linearGradient id="linearGradient4963" y2="104.74" gradientUnits="userSpaceOnUse" x2="229.41" gradientTransform="translate(0 .85421)" y1="109.05" x1="-10.353">
    ...
    <linearGradient id="linearGradient4983" y2="43.606" gradientUnits="userSpaceOnUse" x2="96.841" y1="43.755" x1="-4.508">
      ...
      <stop id="stop9559" style="stop-color:#ffffff" offset="0.4492"/>

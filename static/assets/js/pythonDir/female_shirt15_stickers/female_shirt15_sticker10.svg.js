var item = `<svg class="shirtOverlay" width="86" height="380" viewBox="202.715 584.407 86.5933 380.048" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <defs id="svgEditorDefs">
    ...
    <pattern id="pattern-0" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse" viewBox="0 0 100 100">
      <ellipse transform="matrix(-0.727589, 0.686013, -0.686013, -0.727589, 58.519876, 23.917265)" cx="26.601" cy="32.677" rx="15.798" ry="15.798" style="fill: rgb(19, 22, 19);"/>
      <ellipse transform="matrix(-0.177153, 0.984183, -0.984183, -0.177153, 118.144781, -21.682482)" cx="66.995" cy="49.589" rx="8.342" ry="8.342" style="fill: rgb(225, 192, 135);"/>
      <ellipse transform="matrix(-0.144534, 0.9895, -0.9895, -0.144534, 99.746187, 43.133934)" cx="29.885" cy="75.862" rx="14.769" ry="14.769" style="fill: rgb(232, 170, 93);"/>
      <ellipse transform="matrix(0.014597, 0.999894, -0.999893, 0.014597, 150.245914, -11.06155)" cx="78.161" cy="83.415" rx="22.498" ry="22.498" style="fill: rgb(228, 198, 197);"/>
      <ellipse transform="matrix(-0.615644, 0.788024, -0.788025, -0.615644, 123.865442, -33.532999)" cx="71.429" cy="22.824" rx="6.668" ry="6.668" style="fill: rgb(255, 233, 180);"/>
    ...
    <pattern id="pattern-0-0" patternTransform="matrix(1, 0, 0, 1, 235.602493, 759.214478)" xlink:href="#pattern-0"/>
    <pattern id="pattern-0-1" patternTransform="matrix(1, 0, 0, 1, 233.902222, 718.646851)" xlink:href="#pattern-0"/>
  </defs>
